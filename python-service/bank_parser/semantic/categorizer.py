...
RAW_RULES: list[Rule] = [
    ...
    Rule("pizza",                Category.FOOD,            "debit",  priority=82),
    Rule("bakery",               Category.FOOD,            "debit",  priority=82),
    Rule("bakers",               Category.FOOD,            "debit",  priority=82),
    Rule("sweet",                Category.FOOD,            "debit",  priority=80),
    Rule("sweets",               Category.FOOD,            "debit",  priority=80),
    Rule("kulfi",                Category.FOOD,            "debit",  priority=82),
    Rule("dosa",                 Category.FOOD,            "debit",  priority=82),
    Rule("kitchen",              Category.FOOD,            "debit",  priority=80),
    Rule("kitchens",             Category.FOOD,            "debit",  priority=80),
    Rule("diner",                Category.FOOD,            "debit",  priority=80),
    Rule("food servi",           Category.FOOD,            "debit",  priority=80),
    Rule("foods",                Category.FOOD,            "debit",  priority=80),
    Rule("food and",             Category.FOOD,            "debit",  priority=80),
    Rule("bundl technolog",      Category.FOOD,            "debit",  priority=86),
    Rule("connaught plaza",      Category.FOOD,            "debit",  priority=86),
    Rule("eternal limited",      Category.FOOD,            "debit",  priority=86),
    Rule("sapphire foods",       Category.FOOD,            "debit",  priority=86),
    Rule("eatsure",              Category.FOOD,            "debit",  priority=86),
    Rule("la pinoz",             Category.FOOD,            "debit",  priority=86),
    Rule("bikanervala",          Category.FOOD,            "debit",  priority=84),
    Rule("big chill",            Category.FOOD,            "debit",  priority=84),
    Rule("bakerywala",           Category.FOOD,            "debit",  priority=84),
    Rule("freshius",             Category.FOOD,            "debit",  priority=84),
    Rule("green chick",          Category.FOOD,            "debit",  priority=84),
    Rule("jmd enterprises",      Category.FOOD,            "debit",  priority=83),
    Rule("kwality bakers",       Category.FOOD,            "debit",  priority=84),
    Rule("garg sweets",          Category.FOOD,            "debit",  priority=84),
    Rule("kuremals",             Category.FOOD,            "debit",  priority=84),
    Rule("new albake",           Category.FOOD,            "debit",  priority=84),
    Rule("nayaab kitchen",       Category.FOOD,            "debit",  priority=84),
    Rule("prince pan",           Category.FOOD,            "debit",  priority=84),
    Rule("pushpa food",          Category.FOOD,            "debit",  priority=84),
    Rule("r s foods",            Category.FOOD,            "debit",  priority=84),
    Rule("ravi food",            Category.FOOD,            "debit",  priority=84),
    Rule("the big chill",        Category.FOOD,            "debit",  priority=84),
